...
```
npm create cloudflare@latest -- --template=cloudflare/templates/ancient-dawn-843d
```

A live public deployment of this template is available at [https://ancient-dawn-843d.templates.workers.dev](https://ancient-dawn-843d.templates.workers.dev)
